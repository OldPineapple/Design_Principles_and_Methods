...
/**
 * This class gathers the former several classes
 * and controls the start and end of the action
 * Also it connects sensor, motors to EV3
 * @author Frank P. Ferrie
 *
 */
public class WallFollowingLab {

  // these are the values for some variables

  private static final int bandCenter = 27; // Offset from the wall (cm)
  private static final int bandWidth = 2; // Width of dead band (cm)
  private static final int motorLow = 82; // Speed of slower rotating wheel (deg/sec)
